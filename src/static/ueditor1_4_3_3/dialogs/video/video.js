...
(function(){
    ...
    function initVideo(){
        ...
        (function(){
            ...
            $G("videoWidth").value = 640;
            $G("videoHeight").value = 360;
    ...
    function createPreviewVideo(url){
        ...
        var low = conUrl.toLowerCase();
        // if(low.indexOf('.mp4') > -1 || low.indexOf('.ogg') > -1 || low.indexOf('.webm') > -1 ){
        //     $G("preview").innerHTML = '<video src="'+conUrl+'" controls="controls" width="420" height="280" src="'+conUrl+'">'+
        //                               '</video>';
        // }else{
            $G("preview").innerHTML = '<iframe src="'+conUrl+'" frameborder="no" width="420" height="280"  allowfullscreen="true" allowtransparency="true" ></iframe>';
        //}
    ...
    function insertUpload(){
        var videoObjs=[],
            ...
            width = parseInt($G('upload_width').value, 10) || 640,
            height = parseInt($G('upload_height').value, 10) || 360,
