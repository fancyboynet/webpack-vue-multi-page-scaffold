    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                ...
                //actionUrl = 'http://10.0.2.121:8090/admin/article/image/upload?action=uploadimage';
                //actionUrl = editor.getActionUrl('config');
    ...
    OnlineImage.prototype = {
        ...
        getImageData: function () {
            ...
            if(!_this.listEnd && !this.isLoadingData) {
                ...
                //url = '/api/admin/article/image/getlist'
                //url = 'http://10.0.2.121:8090/admin/article/image/getlist'
                //axios.defaults.withCredentials = true;
                url = window.parent.baseURL+'/admin/article/material/getlist'
                var axios = window.parent.axios
                axios.get(url,{
                    params:{
                        pagenum: 15,
                        materialtype:2,
                ...
                .then(function (res) {
                  try {
                    ...
                    if (res.code == '0') {
                        var arr = []
                        var json = {}
                        res.datalist.map(function(val,i){
                            arr.push({url:val.DataUrl,mtime:val.CreateTime})
                        })
                        json.start = 0;
                        json.list = arr;
                        ...
                        _this.listIndex = parseInt(_this.page) * 15
